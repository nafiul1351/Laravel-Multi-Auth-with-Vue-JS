                ...
                <Form role="form" :validation-schema="schema" @submit="changeUserPicture" @invalid-submit="removeErrors">
                  <div style="padding-left: 10px; padding-right: 10px; padding-bottom: 10px;">
                    <div class="input-group input-group-outline my-3" style="margin-top: 0 !important; margin-bottom: 0 !important;">
                      ...
                      <Field id="image" type="file" class="dropify" data-height="150" name="image" @blur="removeImageError" />
                    ...
                    <div class="text-center">
                      <router-link class="btn bg-gradient-primary w-100 my-4 mb-2" style="width: 192px !important; margin-top: 15px !important;" :to="{name: 'adminProfile'}">Cancel</router-link>
                    </div>
                  </div>
                </Form>
              </div>
