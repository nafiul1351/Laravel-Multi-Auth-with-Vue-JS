...
const store = createStore({
	...
	mutations:{
		...
		updateCredentialsError(state, payload){
			state.credentialsError = payload
		},
	...
	actions:{
		...
		setCredentialsError(context, payload){
			context.commit('updateCredentialsError', payload)
		},
		removeCredentialsError(context){
			context.commit('updateCredentialsError', null)
		},
	...
	getters:{
		...
		getCredentialsError: function(state){
